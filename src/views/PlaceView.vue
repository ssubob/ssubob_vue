          ...
          <div class="row">
            <div class="py-4">
              ...
              <p class="text-body-secondary">
                숭실대학교 주변에 있는 식당, 술집 등의 목록을 보여주는 반응형
                웹입니다.
              </p>
            </div>
          </div>
        ...
        <div class="row py-lg-5">
          <div class="col-lg-12 col-md-8 mx-auto">
            ...
            <a
              @click="getList('한식')"
              href="#"
              class="btn btn-secondary p-4 m-1"
              >한&nbsp;&nbsp;식</a
            >
            <a
              @click="getList('중식')"
            ...
            <div v-for="place in placeList" :key="place.id" class="col">
              <div class="card shadow-sm">
                ...
                <div class="card-body">
                  ...
                  <p style="color: #1b76fb" class="text-center">
                    <strong> 숭실대학교에서 </strong> {{ place.distance }}M
                  </p>
    ...
    <footer class="text-body-secondary py-5">
      <div class="container">
        ...
        <ul class="list-unstyled">
          <li></li>
          <li>
            <a href="https://github.com/ssubob" class="text-black">Github</a>
          </li>
